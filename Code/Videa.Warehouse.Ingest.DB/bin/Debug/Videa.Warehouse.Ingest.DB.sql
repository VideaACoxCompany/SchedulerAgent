...
GO
/*
The column [wis].[BatchProcessingQueue].[LoadDate] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [wis].[BatchProcessingQueue])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [wis].[BatchProcessingQueue]...';


GO
ALTER TABLE [wis].[BatchProcessingQueue] DROP COLUMN [LoadDate];
